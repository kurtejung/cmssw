...
jetDQMAnalyzerAkCs4PF=jetDQMAnalyzerAkCs3PF.clone(src = cms.InputTag("akCs5PFJets"),
						  CScands = cms.InputTag("akCs5PFJets","pfParticlesCs")
)
jetDQMAnalyzerAkCs5PF=jetDQMAnalyzerAkCs3PF.clone(src = cms.InputTag("akCs5PFJets"),
                                                  CScands = cms.InputTag("akCs5PFJets","pfParticlesCs")
)
